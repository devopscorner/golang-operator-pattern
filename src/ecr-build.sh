...
main() {
  # docker_build 0987654321 Dockerfile devopscorner/golang-operator-pattern alpine [version|latest|tags] [custom-tags]
  # docker_build 0987654321 Dockerfile.alpine-3.16 devopscorner/golang-operator-pattern alpine [version|latest|tags] [custom-tags]
  # docker_build 0987654321 Dockerfile.alpine-3.17 devopscorner/golang-operator-pattern alpine [version|latest|tags] [custom-tags]
